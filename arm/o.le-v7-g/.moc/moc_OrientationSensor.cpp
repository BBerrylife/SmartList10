...
static const char qt_meta_stringdata_OrientationSensor[] = {
    "OrientationSensor\0\0tiltUp()\0tiltDown()\0"
};
...
void OrientationSensor::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->tiltUp(); break;
        case 1: _t->tiltDown(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
void *OrientationSensor::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "QAccelerometerFilter"))
        return static_cast< QAccelerometerFilter*>(const_cast< OrientationSensor*>(this));
...
// SIGNAL 0
void OrientationSensor::tiltUp()
{
    QMetaObject::activate(this, &staticMetaObject, 0, 0);
}

// SIGNAL 1
void OrientationSensor::tiltDown()
{
